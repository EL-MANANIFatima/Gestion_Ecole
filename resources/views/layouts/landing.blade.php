          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{route('type')}}"> Log In </a>
                </li>
              </ul>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="detail-box">
                    ...
                    <p>
                    Our school is a renowned educational institution located in a vibrant community. With a rich history spanning several 
                    decades, the school has established itself as a pillar of academic excellence and holistic development. Lachimolala High School
                     is dedicated to providing quality education, nurturing students' talents, and fostering a supportive learning
                    environment
                    </p>
                    <div class="btn-box">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="content-box">
            ...
            <div class="detail-box">
              ...
              <p>
              Our school places safety as its top priority, 
              implementing robust security measures and conducting regular safety drills to ensure the well-being of students. 
              With a strong commitment to creating a secure environment.
        ...
        <div class="col-md-6">
          <div class="content-box">
            ...
            To provide students with individualized attention and 
            a conducive learning environment. With fewer students in each class, teachers can better engage with students,
             address their unique needs, and foster meaningful interactions.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="content-box">
            ...
            <div class="detail-box">
              ...
              <p>
              Exceptional infant care services, providing a nurturing and safe
               environment for the youngest learners. With experienced and caring staff, the school prioritizes
                the well-being and development of infants, offering age-appropriate activities, personalized attention,
                 and a warm and loving atmosphere
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="content-box">
            ...
            <div class="detail-box">
              ...
              <p>
              Lachimolala School fosters creativity through engaging and innovative lessons, 
              inspiring students to think outside the box and unleash their imagination.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="content-box">
            ...
            <div class="detail-box">
              ...
              <p>
              Our chool employs highly qualified and certified teachers who are dedicated to providing quality
               education and ensuring the academic success of their students.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="content-box">
            ...
            <div class="detail-box">
              ...
              <p>
              We foster a happy and positive environment where students feel safe,
               supported, and motivated to learn and grow.
              </p>
            </div>
          </div>
        </div>
  ...
  <section  id="about" class="about_section ">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="{{ asset('black') }}/img/about-img.jpg" alt="">
          </div>
        </div>
        <div class="col-md-5 col-lg-4">
          <div class="detail-box">
            ...
            <p>
            At Lachimolala School, creativity takes center stage. From interactive projects to imaginative lessons, students are encouraged to think outside the box and explore their creative potential. The school provides a supportive environment where students can express themselves freely and develop their artistic abilities.

In addition to academic pursuits, Lachimolala School recognizes the importance of character development. Through various character-building programs and activities, students learn essential values such as integrity, empathy, and resilience. These qualities shape them into responsible and compassionate individuals who positively contribute to their communities.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-6 ">
          ...
          @csrf
            ...
            <div>
              <input type="text" placeholder="Pone Number" name="phone" />
            </div>
            <div>
  ...
  <section class="container-fluid footer_section">
    <p>
      &copy; 2023 All Rights Reserved By Lachimolala School</a>
    </p>
  </section>
  <!-- footer section -->
