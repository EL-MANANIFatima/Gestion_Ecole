...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="{{ $class ?? '' }}">
        ...
        <script src="{{ asset('black') }}/js/jquery-3.3.1.min.js"></script>
        <script src="{{ asset('black') }}/js/jquery-3.4.1.min.js"></script>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $.each(data, function (key, value) {
                                $('select[name="Classe_id"]').append('<option selected disabled >{{trans("Parent_trans.Choose")}}...</option>');
